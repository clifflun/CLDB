...
-    P2_path: Path to the VCF files generated by the (Parliament2)[https://github.com/dnanexus-archive/parliament2] pipeline.

-    MD_path: Path to the (mosdepth)[https://github.com/brentp/mosdepth] 1kb-bin BED files used for read-depth analysis.
