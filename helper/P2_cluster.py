		...
		with gzip.open(fname, 'rt') as f:
			for line in f:
				...
				if line.startswith('#'):
					...
					chrom2 = tmp2[5][5:] #change to 5: if no chr
...
def main():
	P2 = get_P2_df('Z:/Members/clun/CLDB/meta/meta_SR_hg19.tsv')
	print('Writing Results to TSV')
	P2.to_csv('CLDB_P2_031925.tsv', sep='\t', index=False, chunksize=250000)
